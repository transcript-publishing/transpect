...
local function make_partline ( head )
    for n in T ( head ) do
        ...
        elseif n.id == WI and n.subtype == SPECIAL and n.data == "PHPL_part_line" then
            ...
            wi_node.data = "/Artifact BMC q " .. width .. " w " .. width * 0.5 - excess .. " " .. calc_value ( tex.sp ( "-.85em" ) ) + calc_value ( tex.sp ( "1pt" ) ) .. " m " .. width * 0.5 - excess .. " " .. calc_value ( tex.sp ( "-.85em" ) ) .. " l .57 .57 .57 G S Q EMC"
