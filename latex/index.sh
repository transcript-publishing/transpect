...
/usr/local/texlive/2019/bin/x86_64-linux/xindy -v -d script -M transcript.xdy -L $lang -C utf8 -M tex/inputenc/utf8 -M german-sty.xdy -M texindy -M page-ranges -M word-order -M german-sty.xdy -I latex -d level=3 -t xindy.log $1.$idx -o $1.$ind
perl -i -p -0 -e 's/(item[^\n]+)(\\enskip [0-9]{1,2}\n)/$1\\nobreak$2/g' $1.$ind
