...
xindy -d keep_tmpfiles -v -d script -L general -C utf8 -M tex/inputenc/utf8 -M german-sty.xdy -M texindy -M page-ranges -M word-order -M german-sty.xdy -I latex $1.idx
perl -i -p -0 -e 's/(item[^\n]+)(\\enskip [0-9]{1,2}\n)/$1\\nobreak$2/g' $1.ind
